...
function Navbar () {
    return (
        ...
        <nav className="navbar navbar-expand-lg navbar-light 
            custom-color d-flex justify-content-center" id='mainNav' //configuração nav do bootstrap
        > 
            <div className='container-fluid'>
                ...
                <form class="d-flex">
                    ...
                    <button class="btn btn-outline-dark" type="submit" //não apresenta funcionalidade
                    > 
                        Pesquisar
                    </button>
